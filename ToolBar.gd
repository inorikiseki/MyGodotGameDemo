...
var equipped_item_index setget set_equipped_item_index

func set_equipped_item_index(index):
	if items[index] is Item and items[index].is_equipable:
		equipped_item_index=index
	else:
		print(self,"ERROR: cannot equip",items[index])
